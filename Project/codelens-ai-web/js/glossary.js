// js/glossary.js - Programming Terms Across 10 Categories
...
const GLOSSARY_TERMS = [
  ...
  // Additional terms
  { term: 'async/await', definition: 'A modern JavaScript pattern for handling asynchronous operations using the async and await keywords.', category: 'concurrency', language: 'javascript' },
  { term: 'destructuring', definition: 'A syntax that allows unpacking values from arrays or properties from objects into distinct variables.', category: 'functions' },
  { term: 'spread operator', definition: 'A syntax (...) that expands an iterable into its individual elements.', category: 'functions' },
  { term: 'rest parameters', definition: 'A syntax that allows a function to accept an indefinite number of arguments as an array.', category: 'functions' },
  { term: 'template literal', definition: 'A string literal with embedded expressions using backticks and ${} syntax.', category: 'functions', language: 'javascript' },
  { term: 'optional chaining', definition: 'A syntax (?.) that allows accessing nested properties without throwing if intermediate values are null/undefined.', category: 'functions', language: 'javascript' },
  { term: 'nullish coalescing', definition: 'An operator (??) that returns the right-hand operand when the left-hand operand is null or undefined.', category: 'functions', language: 'javascript' },
  { term: 'WebSocket', definition: 'A protocol providing full-duplex communication channels over a single TCP connection.', category: 'web' },
  { term: 'gRPC', definition: 'A high-performance RPC framework that uses HTTP/2 and Protocol Buffers for service communication.', category: 'web' },
  { term: 'GraphQL', definition: 'A query language for APIs that allows clients to request exactly the data they need.', category: 'web' },
  { term: 'WebAssembly', definition: 'A binary instruction format that enables near-native performance in web browsers.', category: 'misc' },
  { term: 'CI/CD', definition: 'Continuous Integration and Continuous Deployment — practices that automate building, testing, and deploying software.', category: 'misc' },
  { term: 'Docker', definition: 'A platform for developing, shipping, and running applications in lightweight containers.', category: 'misc' },
  { term: 'Kubernetes', definition: 'An open-source platform for automating deployment, scaling, and management of containerized applications.', category: 'misc' },
  { term: 'microservices', definition: 'An architectural pattern where an application is composed of small, independent services that communicate over networks.', category: 'web' },
  { term: 'serverless', definition: 'A cloud computing model where the cloud provider manages server allocation and the developer writes stateless functions.', category: 'web' },
  { term: 'event-driven architecture', definition: 'A software architecture pattern where components communicate through events, enabling loose coupling and scalability.', category: 'patterns' },
];
...
export class Glossary {
  ...
  getRandomTerm() {
    const idx = Math.floor(Math.random() * GLOSSARY_TERMS.length);
    return GLOSSARY_TERMS[idx];
  }
}
